...
(function () {
    ...
    function insertCommandPalette(retryCount = 0) {
        ...
        setupCommandInputEventListeners(); // Assuming this function is defined elsewhere
    ...
    document.addEventListener("DOMContentLoaded", () => {
        setTimeout(insertCommandPalette, 5000);
        console.log("Command palette inserted.");
    });
    ...
    setInterval(function () {
        ...
        if (lastHref !== currentHref) {
            ...
            insertCommandPalette(); // Call function when the URL changes
        }
    }, 5000);
